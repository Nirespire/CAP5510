...
public class AddToWatchHistoryTask extends AsyncTask<AsyncTaskInput, Integer, Response> {
    ...
    protected Response doInBackground(AsyncTaskInput... params) {
        ...
        try {
            ...
            String url = c.getString(R.string.url_post_watch_history);
            ...
            Log.e("sanjay", "IO Exception when creating history post object");
            Log.e("sanjay", i.getMessage());
        }
        catch(JSONException e){
            Log.e("sanjay", "JSON Exception when creating history post object");
