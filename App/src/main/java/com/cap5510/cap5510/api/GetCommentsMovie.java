...
public class GetCommentsMovie extends AsyncTask<AsyncTaskInput, Integer, Response> {
    ...
    protected Response doInBackground(AsyncTaskInput... params) {
        ...
        String url = c.getString(R.string.url_movies_partial) + Integer.toString(id) + "/comments?extended=images";
    ...
    protected void onPostExecute(Response result) {
        ...
        try {
            ...
            TableLayout commentTable = (TableLayout) a.findViewById(R.id.movieCommentTable);
